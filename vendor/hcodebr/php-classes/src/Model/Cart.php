...
class Cart extends Model {
	...
	public static function getFromSession()
	{
		...
		if (isset($_SESSION[Cart::SESSION]) && (int)$_SESSION[Cart::SESSION]['idcart'] > 0) {//carrinho está na sessao tem ID

			$cart->get((int)$_SESSION[Cart::SESSION]['idcart']); //carrega carrinho

		} else {

			$cart->getFromSessionID(); //carrega carrinho

			if (!(int)$cart->getidcart() > 0) {//se nao carregou carrinho, cria novo
				...
				$cart->setToSession();// passar carrinho para a sessao
	...
	public function get(int $idcart)
	{
		...
		if (count($results) > 0) {
			...
			$this->setData($results[0]); //coloca dados no proprio objeto
